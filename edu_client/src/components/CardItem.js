...
function CardItem(props) {
  ...
  const Img =
    type === "Quiz"
      ? "https://i.ibb.co/0X4q66w/icon-1-e3e2422cb1e874706a4564d4662e215a-2x.png"
      : "https://i.ibb.co/wsw3w49/Image-12-2x.png";
  return (
    <Grid item sm={3}>
      <Link to={lnk} style={{ textDecoration: "none" }}>
        <Card className={classes.root} style={{ background: back }}>
          <CardContent className={classes.containt}>
            ...
            <Typography className={classes.pos}>{data.name}</Typography>
