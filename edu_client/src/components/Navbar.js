        ...
        <AppBar color="inherit" id="navbar-primary">
          <Toolbar>
            ...
            <div className="ml-auto">
              <Button color="inherit" className="mr-3 border" onClick={this.logoutUser} style={{ textTransform: 'none' }}>
                Logout
            </Button>
              <Button color="inherit" className="mr-3 border" style={{ textTransform: 'none' }}>
                Select Class
            </Button>
            </div>
          </Toolbar>
